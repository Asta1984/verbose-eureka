...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDownIcon width={16} strokeWidth={2} className="shrink-0 text-muted-foreground/80" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUpIcon width={16} strokeWidth={2} />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDownIcon width={16} strokeWidth={2} />
  </SelectPrimitive.ScrollDownButton>
));
